  ...
  return (
   ...
   <span className='Project-title'>
    ...
    <div className='project-tile' >
      ...
      <div className='project-card'> <center> <h3>Youtube Clone</h3>
      <img src={Youtube} alt="profile" className="project-img" />
        <span>Developed a YouTube mimic using React, HTML, CSS, and JavaScript. Seamlessly integrated the <br /> YouTube API for live video content, delivering a responsive and engaging user interface.</span>
        </center>
      </div>
